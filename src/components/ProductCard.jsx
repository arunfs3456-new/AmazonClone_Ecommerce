  ...
  return (
    <motion.div
      ...
      className="bg-white border rounded-lg p-3 cursor-pointer transition-all duration-300 relative
                 sm:w-[250px] min-h-[360px] flex flex-col"
    >
      {discount > 0 && (
      ...
      {/* View Product Button (does NOT trigger card click) */}
      <button
        onClick={(e) => {
        ...
        className="w-full mt-auto py-1.5 bg-orange-500 hover:bg-orange-600 rounded text-white text-xs font-semibold
